...
class SewaLapangan extends React.Component {
constructor(props){
  super(props)
  this.state = {
    dataLapangan : [],
...
BookingLapangan(item){

localStorage.setItem("item_book",JSON.stringify(item))
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHeaderColumn style={styles.columns.price}>Gambar Lapangan</TableHeaderColumn>
              <TableHeaderColumn style={styles.columns.edit}>BooKing</TableHeaderColumn>
            </TableRow>
          </TableHeader>
          <TableBody>
            {this.state.dataLapangan.map(item =>
              <TableRow key={item.id}>
                ...
                <TableRowColumn style={styles.columns.price}><img src={"http://localhost/lapangan/public/images/"+item.gambar} width={200} height={200}/></TableRowColumn>

                <TableRowColumn style={styles.columns.edit}>
                    <FloatingActionButton zDepth={0}
                                          mini={true}
                                          backgroundColor={grey200}
                                          onClick={() => this.BookingLapangan(item) }
